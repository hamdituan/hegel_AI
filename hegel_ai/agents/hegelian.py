...
logger = get_logger("agents.hegelian")


@AgentRegistry.register("hegelian")
class HegelianAgent(Agent):
    """Hegelian philosophical agent."""
...
2. Then analyze using your key concepts: {self.config.concepts}

3. Relate to the passage and respond to other critics
